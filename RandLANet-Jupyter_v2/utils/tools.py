...
class Config:
    num_points = 40960  # Number of input xyz
...
class DataProcessing:
    ...
    def grid_sub_sampling(points, features=None, labels=None, grid_size=0.1, verbose=0):
        """
        CPP wrapper for a grid sub_sampling (method = barycenter for xyz and features
        :param points: (N, 3) matrix of input xyz
        :param features: optional (N, d) matrix of features (floating number)
        :param labels: optional (N,) matrix of integer labels
        :param grid_size: parameter defining the size of grid voxels
        :param verbose: 1 to display
        :return: sub_sampled xyz, with features and/or labels depending of the input
        """
